...
<head lang="en">
  ...
  <title><fmt:message key="error500.page.title" bundle="${lang}"/></title>
...
<div class="not-found" style="width: 900px;">
  <div class="notfound-top">
    <h1><fmt:message key="error500.code" bundle="${lang}"/></h1>
    <h2><fmt:message key="error500.description" bundle="${lang}"/></h2>
  </div>
  <div class="content">
    <img src="<c:url value="/resources/images/green-warn.png"/>" width="120px" height="120px">
    <h3><fmt:message key="error500.detailed.msg" bundle="${lang}"/></h3>
    <ul>
