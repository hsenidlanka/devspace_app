...
<jsp:directive.page import="org.springframework.security.core.userdetails.User"/>
...
<fmt:bundle basename="messages">
    <div class="maincontent" id="wrapper">
        ...
        <div class="topnav">
            <div class="logo">
                <a href="/campaign-management"> <img src="<c:url value="/themes/${theme}/images/logo-rewards.png" />"
                                                     alt="" width="114"/> </a>
