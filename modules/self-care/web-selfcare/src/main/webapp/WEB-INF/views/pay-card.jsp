                        ...
                        <div class="col-md-6">
                            <form role="form">
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="txt-card-name"><fmt:message key="pay.name.on"
                                                                                                  bundle="${lang}"/></label>
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="txt-card-no"><fmt:message key="pay.card"
                                                                                                bundle="${lang}"/></label>
                                ...
                                <div>
                                    <label class="control-label"><fmt:message key="pay.expire"
                                                                              bundle="${lang}"/></label>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="txt-cvv-no"><fmt:message key="pay.security"
                                                                                               bundle="${lang}"/></label>
                                ...
                                <div style="text-align: right;">
                                    <a class="btn btn-success btn-proceed-payment" id="btn-confirm-cardpay"
                                       style="width: 45%; margin-left: 25%;"><span
                                            class="glyphicon glyphicon-send"></span>&nbsp;&nbsp;<fmt:message
                                            key="pay.amount" bundle="${lang}"/> 2000.00)</a>
                                </div>
                            </form>
                        </div>
                        <div class="col-md-6" style="margin-top:20px;">
                            <img src="<c:url value="/resources/images/payment/Credit-Card-Security-Code-Locations.jpg"/>"
                                 width="100%;">
                        </div>
                    </div>
                </div>
