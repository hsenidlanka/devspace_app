...
<div>
    <div id="add-item-breadcrumb-position">
        <ul class="breadcrumb breadcrumb-menu">
            ...
            <li><a href="<c:out value="${url1}"/>"><fmt:message key="package.packageadd.breadcrumb.home"
                                                                bundle="${bundle1}"/></a></li>
            <li><a href="<c:out value="${url1}"/>"><fmt:message key="package.heading" bundle="${bundle1}"/> </a></li>
            <li class="active"><a href="<c:out value="${url2}"/>"><fmt:message
                    key="package.viewpackage.breadcrumb.viewpkg" bundle="${bundle1}"/> </a></li>
        </ul>
    </div>
</div>
...
<div class="form-box" id="view-pkg-form-box">
    <div class="panel panel-default">
        <div class="panel-heading  common-form-headings">
            <h3 class="default-panel-headings"><fmt:message key="package.viewpackage.breadcrumb.viewpkg"
                                                            bundle="${bundle1}"/></h3>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="row itemSearchBar">
                ...
                <div class="col-sm-3">
                   <%-- <button type="button" class="btn btn-success" id="btnViewSearchPkg"><span
                            ...
                            key="package.viewpackage.package.search" bundle="${bundle1}"/>
                    </button>--%>
                </div>
                <div class="col-sm-1"></div>
            </div>
            ...
            <form:form class="form-horizontal" role="form" id="frmViewPkg" action="" method="post">
                <fieldset class="scheduler-border">
                    <legend class="scheduler-border"><fmt:message key="package.viewpackage.package.details"
        ...
        <div class="modal-content">
                ...
                <div class="form-group">
                    ...
                    <div align="center" class="row">
                        <div class="col-xs-6" style="text-align: right"><label><fmt:message
                                key="package.deletemodal.packageid" bundle="${bundle1}"/></label></div>
                        <div class="col-xs-6" style="text-align: left"><label id="lblDeltPkgId"
                                                                              class="delete-lables"> </label></div>
                        <br>

                        <div class="col-xs-6" style="text-align: right"><label><fmt:message
                                key="package.deletemodal.packagename" bundle="${bundle1}"/></label></div>
                        <div class="col-xs-6" style="text-align: left"><label id="lblDeltPkgName"
                                                                              class="delete-lables"> </label></div>
                        <br>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <div class="col-xs-3" align="right">
                    <button class="btn btn-success" type="button" value="Yes" id="btnDeltPkg"><fmt:message
                            key="package.deletemodal.button.yes" bundle="${bundle1}"/>
                    </button>
                </div>
                <div class="col-xs-3" align="left">
                    <button class="btn btn-success" type="button" value="cancel" id="btnCnclDeltPkg"
                            data-dismiss="modal"><fmt:message key="package.deletemodal.button.no" bundle="${bundle1}"/>
                    </button>
                </div>
                <div class="col-xs-3"></div>
            </div>
...
<div class="modal fade" id="pkgEditModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header item-modal-header-style">
                <button type="reset" class="close" data-dismiss="modal" aria-hidden="true"><span
                        class="glyphicon glyphicon-remove"></span></button>
                <div align="center"><span class="glyphicon glyphicon-pencil"></span><fmt:message
                        key="package.packageedit.panel.heading" bundle="${bundle1}"/>
                </div>
            </div>
            <div class="modal-body">

                <form:form class="form-horizontal" role="form" method="post" id="frmEditPkg"
                           action="/admin/packages/edit_package" enctype="multipart/form-data">
                <fieldset class="scheduler-border">
                    <legend class="scheduler-border"><fmt:message key="package.packageedit.form.legend"
                                                                  bundle="${bundle1}"/></legend>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-3" align="right">
                                <label id="lblEditPkgNm"><fmt:message key="package.packageedit.form.pkgname"
                            ...
                            <div class="col-xs-2" align="right">
                                <label><fmt:message key="package.packageeditform.packageprice"
                                                    bundle="${bundle1}"/> </label>
                            </div>
                            <div class="col-xs-2" align="left">
                                <form:input type="text" class="form-control price" id="editPkgPrice" value="0.00"
                                            path="price"/>
                                <br><span id="pkgPriceErrEdt" class="input-group-error"></span>
...
<div class="row" id="accumPrice">
      ...
      <div class="col-xs-2">
          <label class="lblAccumPrice" style="color: #0019ea;"></label>
                        ...
                        <div class="row">
                            <div class="col-xs-3" align="right">
                                <label><fmt:message key="package.packageedit.form.packagedetails"
                                                    bundle="${bundle1}"/> </label>
                            </div>
                            <div class="row col-xs-9" style="padding-left: 30px;">
                                ...
                                <div class="row col-xs-12">
                                    ...
                                    <div class="row item-tbl-row item-tbl-hdr">
                                        <div class="col-xs-2">
                                            <strong><fmt:message key="package.packageedit.form.packagedetails.content"
                                                                 bundle="${bundle1}"/></strong>
                                        </div>
                                        <div class="col-xs-4">
                                            <strong><fmt:message key="package.packageedit.form.packagedetails.itemname"
                                                                 bundle="${bundle1}"/></strong>
                                        </div>
                                        <div class="col-xs-4">
                                            <strong><fmt:message key="package.packageedit.form.packagedetails.itemsize"
                                                                 bundle="${bundle1}"/></strong>
                                        </div>
                                        <div class="col-xs-2">
                                            <strong><fmt:message key="package.packageedit.form.packagedetails.qty"
                                                                 bundle="${bundle1}"/></strong>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row rowtbl item-tbl-row" id="tbleditPkgCont">
                                        ...
                                        <div class="col-xs-2">
                                            <form:input class="form-control qty-spinner" type="number" min="0"
                                                        id="contQty" path="quantity"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="addTo" style="text-align: right">
                                        <button class="btn btn-success btnAddItmPkg" type="button" id="addToEdit"
                                                value="add" onclick="contentPackageEdit()"><span
                                                class="glyphicon glyphicon-plus"></span>Create Package Content
                                        </button>
                                    </div>
                                    <br>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xs-3" align="right">
                                <label><fmt:message key="package.packageeditform.packageimages"
                                                    bundle="${bundle1}"/></label>
                            </div>
                            <div class="col-xs-5">
                                ...
                                <form:input type="file" class="file_upload btn btn-default" path="imageUrl"
                                            id="btnUpldImageEdit" value="Browse"/>
                                <br>
                            </div>
                        </div>
...
<br>
            ...
            <div class="modal-footer" align="right">
                <form:button class="btn btn-success" type="submit" value="Yes" id="btnUpdtPkg"><fmt:message
                        key="package.packageedit.form.button.submit" bundle="${bundle1}"/>
                </form:button>
                <form:button class="btn btn-success" type="reset" value="cancel" id="btnUpPkgCancel"
